package com.ccxt.whl.stickercamera.app.camera.adapter;
...
import com.ccxt.whl.stickercamera.app.ui.CameraMainActivity;
import com.ccxt.whl.stickercamera.app.view.SendingProgressView;
...
public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.CellFeedViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(CellFeedViewHolder viewHolder, int position) {
        ...
        viewHolder.ivFeedCenter.setImageBitmap(BitmapFactory.decodeFile(feedItem.getImgPath()));
    ...
    private void bindDefaultFeedItem(int position, CellFeedViewHolder holder) {
        //new add
        FeedItem feedItem = items.get(position);
        holder.ivFeedCenter.setImageBitmap(BitmapFactory.decodeFile(feedItem.getImgPath()));
        holder.ivFeedBottom.setText(feedItem.getTextContext());
    ...
    @Override
    public void onViewAttachedToWindow(CellFeedViewHolder holder) {
                    ...
                    if (!feedImageTag.getClick().equals("unable")) {
                        tagView.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                Intent intent = new Intent(context, com.ccxt.whl.stickercamera.app.ui.WebActivity.class);
                                intent.putExtra("link",feedImageTag.getClick());
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btnComments) {
            ...
            if (!likedPositions.contains(holder.getPosition())) {
                ...
                if (context instanceof CameraMainActivity) {
                    ((CameraMainActivity) context).showLikedSnackbar();
                }
            }
    ...
    public void updateItems(boolean animated) {
        itemsCount = CameraMainActivity.count;
