...
public class EditTextActivity extends BaseActivity {
    ...
    public static void openTextEdit(Activity mContext, String defaultStr,int maxLength, int reqCode) {
        ...
        i.putExtra(Constant.PARAM_EDIT_TEXT, defaultStr);
        if (maxLength != 0) {
            i.putExtra(Constant.PARAM_MAX_SIZE, maxLength);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        maxlength = getIntent().getIntExtra(Constant.PARAM_MAX_SIZE, MAX);

        String defaultStr = getIntent().getStringExtra(Constant.PARAM_EDIT_TEXT);
        ...
        titleBar.setRightBtnOnclickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constant.PARAM_EDIT_TEXT, inputTxt);
