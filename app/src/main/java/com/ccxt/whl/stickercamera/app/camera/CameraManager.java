...
import com.ccxt.whl.stickercamera.app.camera.ui.CameraActivity;
import com.ccxt.whl.stickercamera.app.camera.ui.CropPhotoActivity;
import com.ccxt.whl.stickercamera.app.camera.ui.PhotoProcessActivity;
...
public class CameraManager {
    ...
    public void processPhotoItem(Activity activity, PhotoItem photo) {
        ...
        if (ImageUtils.isSquare(photo.getImageUri())) {
            ...
            i.setData(uri);
            //TODO稍后添加
            activity.startActivityForResult(i, Constant.REQUEST_CROP);
        }
    }
