package com.ccxt.whl.customview;
...
import com.ccxt.whl.customview.drawable.EditableDrawable;
import com.ccxt.whl.customview.drawable.FeatherDrawable;
import com.ccxt.whl.R;
import com.imagezoom.ImageViewTouch;
import com.ccxt.whl.stickercamera.app.camera.util.Point2D;
import com.ccxt.whl.stickercamera.app.camera.util.UIUtils;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = DemoApplication.getApp().getResources().getDrawable(R.drawable.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = DemoApplication.getApp().getResources().getDrawable(R.drawable.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(DemoApplication.getApp().dp2px(1));
